    ...
    <div class="content-page">
        <div class="content">
            <div class="container-fluid">
                <h4 class="fs-18 fw-semibold py-3">Add Lead</h4>
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('lead.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number_of_pax" name="number_of_pax" class="form-control"
                                        placeholder="Enter Number Of Person" value="{{ old('number_of_pax') }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="medium_of_contact" class="form-select">
                                        ...
                                        @foreach (\App\Enums\MediumOfContact::cases() as $medium)
                                            <option value="{{ $medium->value }}"
                                                {{ old('medium_of_contact') == $medium->value ? 'selected' : '' }}>
