...
<head>
    ...
    {{-- Bootstrap CSS + Icons (since this page no longer extends the master layout) --}}
        ...
        <div id="invoiceBox" class="invoice-box">
            ...
            <div class="top-row">
                <div class="top-left">
                    ...
                    <p class="mb-0"><strong>To:</strong> Mr. {{ $transaction->client->name ?? '-' }}</p>
                </div>
                <div class="top-right">
            ...
            <p class="mb-1"><strong>Guest name:</strong>
                {{ $booking->client->name ?? ($transaction->client->name ?? '-') }}</p>
            ...
            {{-- Booking Cost Summary (client-level totals, same logic as ledger) --}}
            @php
            ...
            <div class="terms-heading-row">
                <span>{{ $booking->client->name ?? ($transaction->client->name ?? '-') }}</span>
