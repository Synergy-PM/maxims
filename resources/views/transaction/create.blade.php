        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="py-3 d-flex align-items-center justify-content-between">
                    <h4 class="fs-18 fw-semibold m-0">Add Transaction</h4>
                        ...
                        <form action="{{ route('transaction.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="booking_for" id="booking_for"
                                        ...
                                        <option value="client"
                                            {{ old('booking_for', 'client') == 'client' ? 'selected' : '' }}>Client
                                        </option>
                                        <option value="company" {{ old('booking_for') == 'company' ? 'selected' : '' }}>
                                            Company</option>
                                    </select>
                                    @error('booking_for')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="payment_type"
                                        ...
                                        <option value="bank_transfer"
                                            {{ old('payment_type') == 'bank_transfer' ? 'selected' : '' }}>Bank Transfer
                                        </option>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="mdi mdi-content-save me-1"></i> Save Transaction
                                </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filterBookings(type, id) {
                ...
                if (oldBookingId && matches.some(b => b.value === oldBookingId)) {
                    bookingSelect.value = oldBookingId;
                }
            }
            ...
            function toggleFields() {
                if (bookingForSelect.value === 'company') {
                    ...
                    filterBookings('company', companySelect.value);
                } else {
                    ...
                    filterBookings('client', clientSelect.value);
                }
            }

            bookingForSelect.addEventListener('change', toggleFields);
            clientSelect.addEventListener('change', function() {
                filterBookings('client', this.value);
            });
            companySelect.addEventListener('change', function() {
                filterBookings('company', this.value);
            });
