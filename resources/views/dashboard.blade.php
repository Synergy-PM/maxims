...
{{-- @section('header-title', 'Welcome' . ' ' . 'hjjh' ) --}}
@section('content')
            ...
            <div class="card-body">
              <div class="">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <div class="">
                    <h3 class="mb-0 text-indigo">168</h3>
          ...
          <div class="card rounded-4 w-100">
            <div class="card-body">
              ...
              <div>
                ...
                <p class="mb-3">Total Reviceable</p>
                {{-- <div id="chart5"></div> --}}
              </div>
            </div>
          </div>
        ...
        <div class="col-12 col-lg-6 col-xxl-2 d-flex">
          <div class="card rounded-4 w-100">
            <div class="card-body">
              ...
              <div>
                <h4 class="mb-0">1.6k</h4>
                <p class="mb-3">Total Supplier</p>
                <div id="chart4"></div>
              </div>
            </div>
          </div>
