                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="current_company_status"
                                                name="current_company_status" placeholder="Enter Current Status"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="director_photo" name="director_photo"
                                                accept="image/*" class="form-control image-input"
                                                data-preview="preview_director_photo">
                                            <div class="mt-2">
                            ...
                            <div class="tab-pane fade" id="contact-details">
                                ...
                                <div id="address-container">
                                    @php $addresses = old('address', isset($company) ? $company->addresses->toArray() : [['address_of'=>'','address'=>'','country'=>'','city'=>'','po_box'=>'','zip_code'=>'','is_preferred'=>false]]); @endphp
                                    @foreach ($addresses as $i => $addr)
                                        <div class="row address-row border-bottom pb-2 mb-2"
                                            data-index="{{ $i }}">
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <label><b>Address Of</b><span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4">
                                                ...
                                                <input type="text" name="address[{{ $i }}][address]"
                                                    value="{{ $addr['address'] ?? '' }}" class="form-control"
                                                    placeholder="Enter Address">
                                            </div>
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <label><b>Country</b><span class="text-danger">*</span></label>
                                                <input type="text" name="address[{{ $i }}][country]"
                                                    value="{{ $addr['country'] ?? '' }}" class="form-control"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-3">
                                                ...
                                                <input type="text" name="address[{{ $i }}][po_box]"
                                                    value="{{ $addr['po_box'] ?? '' }}" class="form-control">
                                            </div>
                                            <div class="col-12 col-sm-6 col-md-3">
                                                <label><b>Zip</b></label>
                                                <input type="text" name="address[{{ $i }}][zip_code]"
                                                    value="{{ $addr['zip_code'] ?? '' }}" class="form-control">
                                            </div>
                                            <div class="col-12 col-sm-6 col-md-3">
                                                ...
                                                <select name="address[{{ $i }}][is_preferred]"
                                                    class="form-control">
                                                    <option value="Yes"
                                                        {{ $addr['is_preferred'] ?? false ? 'selected' : '' }}>Yes</option>
                                                    <option value="No"
                                                        {{ !($addr['is_preferred'] ?? false) ? 'selected' : '' }}>No
                                                    </option>
                                                </select>
                                            </div>
                                ...
                                <div class="mb-4">
                                    <button type="button" class="btn btn-outline-primary btn-sm"
                                        ...
                                        <i class="material-icons-outlined" style="font-size:14px;">add</i> Add
                                    </button>
                                </div>
                                ...
                                <div id="contact-container">
                                    @php $contacts = old('contact', isset($company) ? $company->contactNumbers->toArray() : [['contact_type'=>'','contact'=>'','is_preferred'=>false]]); @endphp
                                    @foreach ($contacts as $i => $con)
                                        <div class="row contact-row border-bottom pb-2 mb-2"
                                            data-index="{{ $i }}">
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <label><b>Contact Type</b><span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-12 col-sm-6 col-md-5">
                                                ...
                                                <input type="text" name="contact[{{ $i }}][contact]"
                                            ...
                                            <div class="col-9 col-md-2">
                                                ...
                                                <select name="contact[{{ $i }}][is_preferred]"
                                                    class="form-control">
                                                    <option value="Yes"
                                                        {{ $con['is_preferred'] ?? false ? 'selected' : '' }}>Yes</option>
                                                    <option value="No"
                                                        {{ !($con['is_preferred'] ?? false) ? 'selected' : '' }}>No
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-3 col-md-1 d-flex align-items-end">
                                ...
                                <div id="email-container">
                                    @php $emails = old('email', isset($company) ? $company->emails->toArray() : [['email_type'=>'','email'=>'','is_preferred'=>false]]); @endphp
                                    @foreach ($emails as $i => $em)
                                        <div class="row email-row border-bottom pb-2 mb-2"
                                            data-index="{{ $i }}">
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <label><b>Email Type</b><span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-12 col-sm-6 col-md-5">
                                                ...
                                                <input type="email" name="email[{{ $i }}][email]"
                                            ...
                                            <div class="col-9 col-md-2">
                                                ...
                                                <select name="email[{{ $i }}][is_preferred]"
                                                    class="form-control">
                                                    <option value="Yes"
                                                        {{ $em['is_preferred'] ?? false ? 'selected' : '' }}>Yes</option>
                                                    <option value="No"
                                                        {{ !($em['is_preferred'] ?? false) ? 'selected' : '' }}>No
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-3 col-md-1 d-flex align-items-end">
                            ...
                            <script>
                                ...
                                function addRow(type) {
                                    ...
                                    firstRow.querySelectorAll('input, select').forEach(function(el) {
                                    ...
                                    let removeBtn = firstRow.querySelector('.remove-btn');
                                    if (!removeBtn) {
                            ...
                            <div class="tab-pane fade" id="licence-details">
                                ...
                                <div id="license-container">
                                    @php $licenses = old('license', isset($company) ? $company->licenses->toArray() : [['license_type'=>'','license_no'=>'','place_of_issue'=>'','date_of_issue'=>'','valid_upto'=>'','is_preferred'=>false]]); @endphp
                                    @foreach ($licenses as $i => $lic)
                                        <div class="row license-row border-bottom pb-2 mb-2"
                                            data-index="{{ $i }}">
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <label><b>License Type</b><span class="text-danger">*</span></label>
                                                <select name="license[{{ $i }}][license_type]"
                                                    class="form-control">
                                                    <option value="">Select...</option>
                                                    @foreach (['Trade License', 'Security License', 'Municipality License', 'Civil Defense License'] as $opt)
                                                        <option value="{{ $opt }}"
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <label><b>License No</b><span class="text-danger">*</span></label>
                                                <input type="text" name="license[{{ $i }}][license_no]"
                                                    value="{{ $lic['license_no'] ?? '' }}" class="form-control"
                                                    placeholder="Enter License No">
                                            </div>
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <label><b>Place of Issue</b><span class="text-danger">*</span></label>
                                                <input type="text"
                                                    name="license[{{ $i }}][place_of_issue]"
                                                    value="{{ $lic['place_of_issue'] ?? '' }}" class="form-control"
                                                    placeholder="Enter Place of Issue">
                                            </div>
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <label><b>Date of Issue</b><span class="text-danger">*</span></label>
                                                <input type="date" name="license[{{ $i }}][date_of_issue]"
                                                    value="{{ $lic['date_of_issue'] ?? '' }}" class="form-control">
                                            </div>
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <label><b>Valid Upto</b><span class="text-danger">*</span></label>
                                                <input type="date" name="license[{{ $i }}][valid_upto]"
                                                    value="{{ $lic['valid_upto'] ?? '' }}" class="form-control">
                                            </div>
                                            <div class="col-9 col-md-4">
                                                ...
                                                <select name="license[{{ $i }}][is_preferred]"
                                                    class="form-control">
                                                    <option value="Yes"
                                                        {{ $lic['is_preferred'] ?? false ? 'selected' : '' }}>Yes</option>
                                                    <option value="No"
                                                        {{ !($lic['is_preferred'] ?? false) ? 'selected' : '' }}>No
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-3 col-md-1 d-flex align-items-end">
